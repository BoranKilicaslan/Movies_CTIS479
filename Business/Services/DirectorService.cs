...
namespace Business.Services
{
    ...
    public class DirectorService : IDirectorService
    {
        ...
        {
            return _db.Director.Include(r => r.Movies).Select(r => new DirectorModel()
            {
        ...
        public Result Add(DirectorModel model)
        {
            ...
            var nameSqlParameter = new SqlParameter("Username", model.Name.Trim()); // using a parameter prevents SQL Injection
