...
namespace MVC.Controllers
{
    public class DirectorsController : Controller
    {
        ...
        {
            DirectorModel director = _directorService.Query().SingleOrDefault(r => r.Id == id); ; // TODO: Add get item service logic here
            if (director == null)
            {
                return NotFound();
            }
        ...
        public IActionResult Login(DirectorModel director)
        {
            // checking the active user from the database table by the user name and password
            var existingUser = _directorService.Query().SingleOrDefault(u => u.Name == director.Name && u.Surname == director.Surname);
