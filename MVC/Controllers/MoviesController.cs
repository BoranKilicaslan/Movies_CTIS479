...
namespace MVC.Controllers
{
    public class MoviesController : Controller
    {
        ...
        private readonly IDirectorService _directoryService;


        public MoviesController(IMovieService movieService, IDirectorService directoryService)
        {
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.Directors = new SelectList(_directoryService.Query().ToList(), "Id", "Name");
            return View();
        }
